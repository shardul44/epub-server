...
CREATE TABLE IF NOT EXISTS organizations (
    ...
    pdf_page_quota INT NULL COMMENT 'Total PDF pages for subscription period',
    pdf_pages_used INT NOT NULL DEFAULT 0 COMMENT 'PDF pages consumed in current subscription period',
...
-- Per-user activity log (visibility scoped by role in the API)
