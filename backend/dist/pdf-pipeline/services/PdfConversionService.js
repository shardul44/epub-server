...
export class PdfConversionService {
     ...
     */
    static async convert(jobId, options = {}) {
        ...
        try {
            ...
            const { elements, pages: rawPages } = await HtmlParserService.parseHtmlFiles(htmlResult.htmlFiles, htmlResult.cssFiles);
            pdfPipelineJobStore.update(jobId, {
                progress: 40,
            ...
            const coords = await CoordinateService.produce(layout.coords, pages, allWords, sentences, layout.sourcePdf);
            pdfPipelineJobStore.update(jobId, {
                progress: 85,
            ...
            }, coords, options, ordered, htmlResult.htmlFiles);
    ...
    static async initializeJob(jobId, sourcePdfPath) {
...
//# sourceMappingURL=PdfConversionService.js.map