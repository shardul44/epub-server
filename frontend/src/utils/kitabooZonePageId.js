 ...
 * Mirrors backend/src/utils/kitabooZonePageId.js for FXL Sync Studio UI.
 */
...
/**
 * @param {string} zoneId
 * @param {Map<string, number>|null|undefined} zoneIdToPageMap
 * @returns {number} page number (>=1)
 */
